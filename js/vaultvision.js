...
function initAuth() {
  ...
  const process = {
    "env" : {
     "VV_AUTHORITY": 'https://bubble.2faez.com',
     "VV_CLIENT_ID": 'VTDDLD3Lpv7DTxx-',
     "VV_CALLBACK_URI": 'https://vvbubble.bubbleapps.io/version-test/oidc_callback',
     "VV_POST_LOGOUT_URI": 'https://vvbubble.bubbleapps.io/version-test',
